...
async def lifespan(app: FastAPI):
    ...
    print("点菜系统API启动成功！")
    print("=" * 50)
    print("📱 用户端页面: http://72.11.140.254:8000/demo.html")
    print("🏪 商家端页面: http://72.11.140.254:8000/merchant.html")
    print("📖 API文档: http://72.11.140.254:8000/docs")
    print("🔌 WebSocket: ws://72.11.140.254:8000/ws/merchant")
    print("=" * 50)
